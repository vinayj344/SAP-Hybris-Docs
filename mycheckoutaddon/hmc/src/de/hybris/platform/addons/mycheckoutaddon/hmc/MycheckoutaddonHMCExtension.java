 ...
 *
 */
package de.hybris.platform.addons.mycheckoutaddon.hmc;
...
/**
 * Provides necessary meta information about the mycheckoutaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.7.0.9
 */
public class MycheckoutaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(MycheckoutaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "de.hybris.platform.addons.mycheckoutaddon.hmc.locales";
