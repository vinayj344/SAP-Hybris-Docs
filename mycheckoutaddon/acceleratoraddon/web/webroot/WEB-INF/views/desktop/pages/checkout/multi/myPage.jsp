...
<template:page pageTitle="${pageTitle}" hideHeaderLinks="true">
	...
	<div class="span-14 append-1">
		<div id="checkoutContentPanel" class="clearfix">
			...
			<a class="button" href="${cancelSelectGiftWrapUrl}"><spring:theme
					code="checkout.multi.cancel" text="Cancel" /></a> <a class="button"
				href="${continueSelectGiftWrapUrl}"><spring:theme
					code="checkout.multi.deliveryMethod.continue" text="Continue" /></a>
		</div>
	</div>
