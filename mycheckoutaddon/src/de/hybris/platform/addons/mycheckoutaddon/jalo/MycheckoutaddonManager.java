 ...
 *
 */
package de.hybris.platform.addons.mycheckoutaddon.jalo;
...
import de.hybris.platform.addons.mycheckoutaddon.constants.MycheckoutaddonConstants;



/**
 * This is the extension manager of the Mycheckoutaddon extension.
 */
public class MycheckoutaddonManager extends GeneratedMycheckoutaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MycheckoutaddonManager.class.getName());
	 ...
	 */
	public static MycheckoutaddonManager getInstance()
	{
		return (MycheckoutaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MycheckoutaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MycheckoutaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MycheckoutaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MycheckoutaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MycheckoutaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
